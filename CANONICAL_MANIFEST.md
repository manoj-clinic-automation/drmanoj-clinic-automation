...
| Doc | Version | md5 | Notes |
|---|---|---|---|
| `KB_History_Archive` | **v1.51** | `b899806b35077a7c95dd737adb560827` | **CURRENT.** **§S204 appended at the S204 close.** §S204 is the last section. **Pure append proven mechanically**: the first 914,045 bytes are byte-identical to v1.50 (+13,791). The v1.50 end-marker is preserved in place as a historical truncation-proof. |
