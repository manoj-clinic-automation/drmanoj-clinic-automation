# Clinic Master KB / Systems Register — v1.47 (CONSOLIDATED)

**Dr. Manoj Agarwal Clinic · Bareilly · Owner: Dr. Manoj Agarwal · Maintained with: Claude**

> **v1.47 is a FULLY CONSOLIDATED, self-contained master** (single file, no delta chain — S100 policy). It carries everything below plus **§123 (Session 123): the Stage-3 claim-match join REDESIGN (`call_verdict.py`), the enriched `Call_Verdicts` row, judge-once-fill-later, and decisions D150–D154** — the join went from 0/15 to a proven 16/22 (73%) on real data (06-Jul).
>
...
## DECISIONS INDEX — CONSOLIDATED (D121–D154)
...
- **Next free decision number for new work: D155.**
