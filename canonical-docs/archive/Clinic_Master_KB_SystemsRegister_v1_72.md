...
**END OF MASTER KB v1.72. §S146 is the last section, and its DECISION D246 block is its last subsection. §S145 sits immediately above it. The CHANGELOG's newest entry is `v1.72`. If any of these is absent, this file is truncated and must not be used as canonical.**