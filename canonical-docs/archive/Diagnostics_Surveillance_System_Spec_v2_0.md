# DIAGNOSTICS & SURVEILLANCE SYSTEM SPEC — v2.0 (CONSOLIDATED, SELF-CONTAINED)
...
**END OF DIAGNOSTICS & SURVEILLANCE SYSTEM SPEC v2.0 — "WHAT THIS DOCUMENT STILL OWES" is the last section. If it is absent, this file is truncated and must not be used as canonical.**
