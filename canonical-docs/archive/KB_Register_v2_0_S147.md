# KB REGISTER — v2.0 (Tier 0 · current state · rides the session loop)
...
> **How to use.** *Now* → this file. *History* → **KB History Archive v1.0** (Tier 1). *Live backlog* → **HANDOFF_RUNBOOK §2**. *Findings register* → **Fault_Action_Register v2.1** (Tier 1). *Doc manifest + hashes* → **CANONICAL_MANIFEST.md**.
