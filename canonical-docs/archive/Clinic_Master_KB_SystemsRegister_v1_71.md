...
**END OF MASTER KB v1.71. §S145 is the last section, and its DECISIONS D244–D245 block is its last subsection. §S144 sits immediately above it. The CHANGELOG's newest entry is `v1.71`. If any of these is absent, this file is truncated and must not be used as canonical.**