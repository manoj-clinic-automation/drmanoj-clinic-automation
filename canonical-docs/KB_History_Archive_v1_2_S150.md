# KB HISTORY ARCHIVE — v1.2 (Tier 1 · append-only · out of the session loop)

**Dr. Manoj Agarwal Clinic · Bareilly · created S147, carried VERBATIM from Clinic_Master_KB_SystemsRegister v1.72 (md5 27b72639…).**

> This file holds the project's HISTORY: every session narrative (§S…) and every full-text decision block, unaltered. Authority on *what happened*. For *what is true now*, read the **KB Register v2.3** (Tier 0). Opened on demand only. (D247)
...
**END OF KB HISTORY ARCHIVE v1.2. §S150 is the last section; §S149, §S148, §S147 and §S146 sit above it. If §S150 or this marker is absent, this file is truncated and must not be used as canonical.**
