...
**END OF FAULT → ACTION REGISTER v2.1 — §6 and the CHANGELOG are the last sections. If either is absent, this file is truncated and must not be used as canonical.**
