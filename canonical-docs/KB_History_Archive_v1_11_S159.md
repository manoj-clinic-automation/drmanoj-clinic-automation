# KB HISTORY ARCHIVE — v1.11 (Tier 1 · append-only · out of the session loop)
...
**END OF KB HISTORY ARCHIVE v1.11. §S159 is the last section; §S158, §S157 and earlier sit above it. If §S159 or this marker is absent, this file is truncated and must not be used as canonical.**
