...
| Doc | Version | md5 | Notes |
|---|---|---|---|
| `KB_History_Archive` | v1.19 | `c8203c7a87fdfd336ca995f0aba0e328` | all history, verbatim; from v1.72 (`27b72639…`). §S162–§S166 appended; §S167 is last; END-marker present (truncation guard). Pure-append proven at each EOS. |
...
| `Fault_Action_Register` | v2.13 | `303554766792fa61d82ef213bbfa7adc` | findings register (F-##). **v2.8 (S162)** F-65; **v2.9 (S163)** F-66/F-67; **v2.10 (S164)** F-67 CLOSED + F-68; **v2.11 (S165)** F-69 + F-70; **v2.12 (S166)** F-71. §0–§6 lanes unchanged. |
...
**END OF CANONICAL_MANIFEST — S167.**
