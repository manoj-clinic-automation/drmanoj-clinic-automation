...
|---|---|---|---|
| `CANONICAL_MANIFEST.md` | S171 | *(self — recomputed last, each EOS)* | this file; the linchpin (the S169 version-cell lag noted at S171 open is fixed here) |
| `START_HERE_SESSION_172` | S171 | `7b7046d3ba27b0cb8fad5bc1695d7eec` | entry point; regenerated every close-out (S162–S171 entry files are superseded) |
| `KB_Register` | v4.4 | `81ca133803d76aebe6eac693c3ad01ce` | current state; from v1.72 (`27b72639…`). **S162 → v3.5** (Stage-B lock + biometric grid + portal tiles; D283–D288; F-65). **S163 → v3.6** (standalone register salary, July-proven; D289–D290; F-66/F-67). **S164 → v3.7** (F-67 fix keys off approved capture; pending-review board; Shivani maker; portal user admin; consolidated dossier; D291–D294; F-67 closed / F-68; Archive ptr → v1.16; Fault ptr → v2.10). **S165 → v3.8** (§S165 STATE; D223 gist delivered — D295–D296; F-69/F-70; Archive ptr → v1.17; Fault ptr → v2.11). **S166 → v3.9** (§S166 STATE; D297 Call-Console signed; F-71). **S167 → v4.0** (Stage A `console.db` builder live; D298; F-72/F-73). **S168 → v4.1** (Stage B1 page live + Stage-2a backfill built; D299–D300; F-74). **S169 → v4.2** (Stage-2a INSTALLED, `call_agent` 1001 exact; portal rev4 built+F-63-passed, staged; D301–D302; rev5 punch-list adopted; Archive ptr → v1.21; Fault → v2.14). **S170 → v4.3** (rev5 punch-list EXECUTED — Items 1–8 + Track M LIVE; cron D303; stores D304; waves D305; F-75; Archive ptr → v1.22; Fault → v2.15). **S171 → v4.4** (console FINISHED — v3 FINAL live `d74aa3f9…`; enrichment live; digest→portal; D306–D308; F-76 withdrawn/F-77–F-80 closed/F-81 OPEN; Archive ptr → v1.23; Fault → v2.16). |

| `HANDOFF_RUNBOOK` | v109 (S171) | `d7dd5600e264d0894bbdebcab3ea33b2` | §0 what happened · §2 live backlog — ⭐S172 = F-81 duplicate-calls investigation, then console follow-ons; file `HANDOFF_RUNBOOK_2026-08-12_Session171close_v109.md` |
...
| Doc | Version | md5 | Notes |
|---|---|---|---|
| `KB_History_Archive` | v1.23 | `96dc410971f46ab54bff1a047ff42ee2` | all history, verbatim; §S171 is last (pure-append proven, prefix byte-identical, +10200 chars); END-marker present. |
...
| `Fault_Action_Register` | v2.16 | `1702b5a8e0663847eaa097919aea94d3` | findings register (F-##). **v2.8 (S162)** F-65; **v2.9 (S163)** F-66/F-67; **v2.10 (S164)** F-67 CLOSED + F-68; **v2.11 (S165)** F-69 + F-70; **v2.12 (S166)** F-71. §0–§6 lanes unchanged. **v2.15 (S170)** F-75. **v2.16 (S171)** F-76(withdrawn)·F-77·F-78·F-79·F-80(closed)·F-81(OPEN). |
| `GAS_Outcome_Vocabularies_v1_S171` | v1 | `71140b7b2259d8e6e04f04691b777fff` | NEW S171 — verbatim K/FU/IN/L outcome sets + K_CODE_MAP + Hindi coaching map; seeds `console_options` + `HI_OUTCOME`; code wins over doc summaries (D172) |
...
| `Console_Rev5_Punchlist` | v1 (S169) | `e8f707d7be1fb20b20e360ba9453df9a` | **the autonomous console build plan (D302)** — ordered items (arm cron · install rev4 · AI reason/lag · row-level context · Track R review→dispositions · send-back · no-show Track N · rec proxy · Marketing/Conversion/Revenue/Digest · rubric), each with source·file·function·change·gate·install·acceptance. Next session executes off this. |
...
**S169 canonical filenames (Phase-0 mapping):** `KB_Register_v4_2_S169.md` · `KB_History_Archive_v1_21_S169.md` · `HANDOFF_RUNBOOK_2026-08-11_Session170_v107.md` · `START_HERE_SESSION_170.md` · `Console_Rev5_Punchlist_v1_S169.md` (new Tier-1) · `Fault_Action_Register_v2_14.md` (UNCHANGED) · this `CANONICAL_MANIFEST.md`. (D297 contract + build dossier + Salary/Attendance Dossier + all other Tier-1/2 rows **UNCHANGED** — re-hashed clean.)
- **Tier-0/1 bumps (S169):** `KB_Register` v4.1 → **v4.2** (`d865341e9259fe886ed523c39db95f9b`); `KB_History_Archive` v1.20 → **v1.21** (`c47a2dde06a2efc9da492f7d16d99ccd`, §S169 pure-append, prefix byte-identical); `HANDOFF_RUNBOOK` v106 → **v107** (`5469120fc20e4ff3693044360d0722d0`); `START_HERE_SESSION_169` → **`START_HERE_SESSION_170`** (`ce1724a8c55d91283b6bd3c38ae51065`); NEW Tier-1 `Console_Rev5_Punchlist_v1_S169` (`e8f707d7be1fb20b20e360ba9453df9a`). `Fault_Action_Register` UNCHANGED (v2.14, no new finding). Live VPS code (builder `00b2175f`, portal rev4 `a7043849` staged) tracked in the Register, not doc-canon.

### §S170 EOS (11 Aug 2026, FULL — rev5 punch-list Items 1–8 + Track M ALL LIVE; cron armed; D303–D305; F-75)
**S170 canonical filenames (Phase-0 mapping):** `KB_Register_v4_3_S170.md` · `KB_History_Archive_v1_22_S170.md` · `HANDOFF_RUNBOOK_2026-08-11_Session170close_v108.md` · `START_HERE_SESSION_171.md` · `Fault_Action_Register_v2_15.md` · this `CANONICAL_MANIFEST.md`. (Punch-list + D297 contract + build dossier + all other Tier-1/2 rows **UNCHANGED** — the punch-list's item COMPLETION is state, carried by the Register/Runbook, not a doc edit.)
- **Tier-0/1 bumps:** Register v4.2 → **v4.3** (`74c45e29d3fe8dd2491fb2b2d0809dcf`); Archive v1.21 → **v1.22** (`7f7047ca8a7bc984dec954baa9138a98`, §S170 pure-append); Runbook v107 → **v108** (`8fb63ed48a76ea7836e5010d93574fee`); START_HERE 170 → **171** (`7a0ea2e10aeefdf34ec4894219682ebf`); Fault v2.14 → **v2.15** (`6cef75639c154e589e5d6403d62264ee`, F-75).
- **Live VPS code (Register-pinned, NOT manifest rows; F-31):** `portal_console.py` **`00b2175f…` → w1 `da3e29d2…` → w2 `e3e2cdb4…` → w3 `4be52ab9449e95f8fd0b6be38919490c` LIVE** · `portal.py` **`7a862f74…` → rev4 `a7043849…` → w1 `a5626e11…` → w2 `585e691c…` → w3 `b513c67ab4539fe6aa27cc243816d37f` LIVE** (backup chains in Archive §S170). Console cron ARMED (D303). NEW PHI stores `console_reviews.db` + `rec_cache/` (D304) — **`.gitignore` extension MANDATORY before any commit.**
- **D303–D305 · F-75** (full text Archive §S170). W2/W3 page acceptance owed (S171 task 0). Next free: **D306 · F-76 · Session 171.**

### §S171 EOS (12 Aug 2026, FULL — the CONSOLE FINISHED: sweep signed off · nine installs · v3 FINAL live · Hindi coaching report · D306–D308 · F-76 withdrawn / F-77–F-80 closed / F-81 OPEN)
**S171 canonical filenames (Phase-0 mapping):** `KB_Register_v4_4_S171.md` · `KB_History_Archive_v1_23_S171.md` · `HANDOFF_RUNBOOK_2026-08-12_Session171close_v109.md` · `START_HERE_SESSION_172.md` · `Fault_Action_Register_v2_16.md` · `GAS_Outcome_Vocabularies_v1_S171.md` (NEW Tier-1) · this `CANONICAL_MANIFEST.md`. (All other Tier-1/2 rows UNCHANGED — re-hash clean.)
- **Tier-0/1 bumps (md5s pinned this EOS):** Register v4.3 → **v4.4** (`81ca133803d76aebe6eac693c3ad01ce`); Archive v1.22 → **v1.23** (`96dc410971f46ab54bff1a047ff42ee2`, §S171 pure-append, prefix byte-identical, +10200 chars); Runbook v108 → **v109** (`d7dd5600e264d0894bbdebcab3ea33b2`); START_HERE 171 → **172** (`7b7046d3ba27b0cb8fad5bc1695d7eec`); Fault v2.15 → **v2.16** (`1702b5a8e0663847eaa097919aea94d3`); NEW Tier-1 `GAS_Outcome_Vocabularies_v1_S171` (`71140b7b2259d8e6e04f04691b777fff`).
- **Live VPS code (Register-pinned, NOT manifest rows; F-31):** `portal.py` **`b513c67a…` → `e6b80f0a…` → `81e9ec58…` → w6 `11f1aea8…` → v3 FINAL `d74aa3f9054430981e719dcc7830cad6` LIVE** · `portal_console.py` **`4be52ab9…` → `393a92b1…` → `552135b53564491dfe5629b2311b2076` LIVE** (P2 enrichment 7,610 rows; D306 sheet-push removed) · `daily_digest.py` **`0a4ee35b…` → `8140f54310bc19c238e9cf11f34b21e7` LIVE** (reads `console.db`). PHI stores unchanged + gitignored.
- **D306–D308 · F-76(w)/F-77/F-78/F-79/F-80/F-81** (full text Archive §S171). Next free: **D309 · F-82 · Session 172.**

**END OF CANONICAL_MANIFEST — S171.**
