#!/bin/bash
# =============================================================================
#  install_h1b.sh · kit S187_H1b — the Hub under Clinic Design Language v1.
#
...
#
#  Rehearsal: H1B_FIN=/tmp/x/finance H1B_DEPLOY=/tmp/x/deploy bash install_h1b.sh
# =============================================================================
set -u
KIT_NAME="S187_H1b"
...
OLD_PAGE="e7ae6208860ca671ed4ce1f0b11dc548"
NEW_PAGE="29eb6326a8c6a6d8b1a8b7620479fbf6"
...
&& echo "-- payload hash matches the Register v5.20 pin" \
...
elif [ "$P" = "$OLD_PAGE" ]; then
  echo "-- currency gate OK: the page is the H1a build"
else
...
cp -f live_pins_H1b.txt "$DEP/live_pins.txt" \
