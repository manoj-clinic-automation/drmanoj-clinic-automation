...
# -*- coding: utf-8 -*-
"""
selftest_phonebook.py -- S225 (rev 7): the rev-6 selftest as regression (rounding now in the engine), then §14 the phone book. Base: the S224 selftest UNCHANGED as regression, then §13 the staff order page. Base: the REAL blueprint, on a temp finance.db, fed the REAL
