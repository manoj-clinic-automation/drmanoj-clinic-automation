"""
salary_policy.py — v1.13 (S239, the owner, 11-Sep-2026) — the "All fines, leaves & credits"
    ...
    if staff is None:
        ...
        for st in res["staff"]:
            out.append("<tr><td><b>%s</b></td><td class='n'>%d</td><td class='n'>%d</td>"
                       ...
                       + ("<td class='n'>%d</td><td class='n'>%s</td>"
                          % (st.get("extra_days", 0), money(st.get("extra_rs", 0)))
                          if (st.get("extra_days") or st.get("extra_rs"))
                          else "<td class='n'>-</td><td class='n'>-</td>")
                       + "</tr>")
        out.append("</table></div>"
                   ...
                   "cover-eligible person's cover days and their extra-duty credit. "
