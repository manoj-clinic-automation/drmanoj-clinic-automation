#!/usr/bin/python3
# -*- coding: utf-8 -*-
"""selftest_s356.py -- S356_DAY_TRUTH_2: the resync proven on a scratch database.
...
Darpan's spellings, a person's bill not, a credit note said not held, a
...
finance_upi is importable (--finance-dir), the exception is proven closed too.
    ...
    python3 -B selftest_s356.py [--finance-dir /root/finance]
...
def main():
    ...
    try:
        ...
        check("dry run pass 2: a credit note is said, not held", "CN1 is a home medicine CREDIT NOTE of 2300.00" in d.stdout)
        con.close()
        ...
        check("03: the resolved review's Home Medisun added; the credit note not",
