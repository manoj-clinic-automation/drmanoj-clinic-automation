...
with sync_playwright() as pw:
    ...
    chk("...the proof sits ABOVE the remaining-work sheet link, the result sheet still offered",
        pg.locator("#padout a.dl").count() in (2, 3, 4, 5, 6) and pg.locator("#padout a.dl").nth(0).get_attribute("class").endswith("proof")
        and pg.locator("#padout a.dl").nth(1).inner_text() == "Download SHEET 2 REMAINING")   # S227 DIFF SHEET adds a third link below
