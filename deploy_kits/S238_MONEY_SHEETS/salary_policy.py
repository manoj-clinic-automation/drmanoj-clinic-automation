"""
salary_policy.py — v1.8 (S238) — THE ADVANCE LINE IS THE LEDGER'S OWN (D349/D442):
...
def sheet2_html(res, doors=False, ledger_prefix="/ledger", back=None,
    ...
    out.append("<section class='s2sec'><h2>Advances taken this month</h2><div class='tw'><table>"
               ...
               "<th>How it is recovered</th><th class='noprint'></th></tr>")
    any_a = False
    for st in pick:
    ...
    # S238: the open position AS AT THE MONTH'S END, from the ledger's own rows —
    ...
    if staff is None:
        out.append("<section class='s2sec'><h2>All fines, leaves &amp; credits (every staff — for review)</h2>"
                   "<div class='tw'><table class='wide'><tr><th>Staff</th><th>Leaves</th>"
