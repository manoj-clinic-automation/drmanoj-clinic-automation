...
| `KB_Register` | **v5.43** | `cc4aefba717028fc55df79f921b44f68` | **CURRENT.** **v5.43 (S198 close):** the eight-kit fold — three live files moved (`portal.py` → `ab019dda…` · `finance_app.py` → `2c99b2c6…` smoke 680 · `portal_gist.py` → `ef3ad196…`, full chains in the table); **D335** into the decisions index (SIGNED); findings F-170…F-173; next free D336 · F-174; lineage row; reverse-application-proven onto the `2d7ca7be…` pin. |
...
**END OF CANONICAL_MANIFEST — S198 CLOSE.**
