#!/usr/bin/env python3
"""
patch_finance_app_panel.py -- S211: ONE read-only JSON endpoint for the console.
...
def main(argv):
    ...
    bak = "%s.bak_S211_daygaps_%s" % (p, datetime.datetime.now().strftime("%Y%m%d_%H%M%S"))
    shutil.copy2(p, bak)
