#!/usr/bin/env python3
"""walk_s332.py -- the live-shape walk of the patient-record page: THE REAL finance_app.py (patched) over
...
def main():
    ...
    os.environ["FINANCE_CRON_TOKEN"] = "walk-token-s332"
    ...
    T = {"X-Finance-Cron": "walk-token-s332"}
    ...
    fid = con.execute("SELECT id FROM record_file WHERE clinic_id=? AND drive_id<>'' ORDER BY id LIMIT 1", (cid,)).fetchone()[0]
