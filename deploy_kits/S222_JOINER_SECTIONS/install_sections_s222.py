...
# -*- coding: utf-8 -*-
"""
install_sections_s222.py -- S222: the form by system, and no typing what can be chosen.
...
EXPECT_FROM = "7bc51dfa3b9d652e7073c1c4c8e7d01f"
EXPECT_TO = "71540e8c610b02636d08ae7d0739df1d"
...
def main():
    ...
    if cur != EXPECT_FROM:
        raise SystemExit("REFUSED: the live page is %s, not the %s this kit was built against "
                         "(S222_PORTAL_ENTRY must be in first). NOTHING was changed." % (cur, EXPECT_FROM))
