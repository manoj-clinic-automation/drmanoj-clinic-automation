...
with sync_playwright() as pw:
    ...
    chk("...the lanes got their usual answers: recount -> RECOUNT, over -> EXPLAINED, bill -> VERIFY_BILL, marg -> MARG_FIX, loss -> RECOVER, orthotic -> MARG_FIX (the ortho card main), dead D -> WRITE_OFF",
