#!/bin/bash
# S216_AYUSH_NAMES - PAGE ONLY. Display naming for Ayushman packages.
# The government claim strings (hpkg/hproc) are NOT changed by this kit.
set -e
K=$(cd "$(dirname "$0")" && pwd)
TS=$(date +%Y%m%d_%H%M%S)
\cp -v /root/wa/casepack/casepack_page.html "/root/wa/casepack/casepack_page.html.bak_S216_AYUSH_$TS"
