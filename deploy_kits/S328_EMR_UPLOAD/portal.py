...
TILES = [
    ...
    {"icon": "\U0001F4D4", "name": "Petty book",
     ...
     "url": "/finance/petty",
     "roles": ["doctor"]},
    {"icon": "\U0001F4E4", "name": "X-ray EMR upload",
     # S328 NEW (owner, 19-Sep-2026). Reception's list of X-rays still to be uploaded into the patient's
     # Docterz record (carried from the X-ray PC by pen drive): backlog oldest first, one tap per X-ray.
     # Same server unit as the slip tile ('slips'). Granted by name in v21.
     "desc": "Docterz mein X-ray upload \u2014 baaki / ho gaye",
     "live": True,
     "url": "/finance/slips/emr",
     "roles": ["doctor"]},
