...
S394 (24-Sep-2026) -- the owner: a 'saved' message useful to Bhati, with the amount, the name and the kind of entry,
...
_audit = None
UNIT = "petty"
APP_VERSION = "S394-PETTY-BOOK-1.3"
_schema_done = False
...
def save_entry():
    ...
    first = con.execute("SELECT id FROM petty_entry WHERE void_at='' AND kind=? AND party=? AND other_name=? AND amount_p=? "
...
KIND_HI = {"receive": ("पैसे मिले", "किससे"), "topup": ("डायरी भरी", "किसकी"), "pay": ("भुगतान किया", "किसको"),
