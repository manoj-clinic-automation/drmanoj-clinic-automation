...
# -*- coding: utf-8 -*-
"""
install_entry_s222.py -- S222: land straight on the form or the picker.
...
EXPECT_FROM = "8300adab775d7e7918c7ed9d07344901"
EXPECT_TO = "7bc51dfa3b9d652e7073c1c4c8e7d01f"
...
def main():
    ...
    if cur != EXPECT_FROM:
        raise SystemExit("REFUSED: the live page is %s, not the %s this kit was built against "
                         "(S222_JOINER_FORMS must be in first). NOTHING was changed." % (cur, EXPECT_FROM))
