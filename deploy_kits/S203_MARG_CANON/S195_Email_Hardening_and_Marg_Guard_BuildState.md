...
> **Superseded on 26-Aug-2026 by `MARG_AND_MEDICAL_PC_MASTER_REFERENCE_v3.md` §3.1**
> (md5 `579ea885e440e76af73de3ecc4542d71`), with the session narrative in
> `KB_History_Archive_v1_49_S202.md` §S195 (md5 `06c6670a8a1155959e4f0961ad58e7c5`).
> This is build state for kits long since installed. Master §3.1 **measured the medical PC on
> 26-Aug** and found that the guard chain described here — `GUARD_AND_SEND.bat` and its companions
> — **is not on that machine at all**, which is why AF-1 cannot fire against it. The e-mail
> hardening half belongs to a different subsystem and lives in the Archive.
