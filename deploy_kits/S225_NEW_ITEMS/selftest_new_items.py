...
# -*- coding: utf-8 -*-
"""
selftest_new_items.py -- S225 (rev 10): the rev-9 selftest as regression, then §18 the new-items log. Base: the rev-6 selftest (rounding now in the engine), then §14 the phone book. Base: the S224 selftest UNCHANGED as regression, then §13 the staff order page. Base: the REAL blueprint, on a temp finance.db, fed the REAL
