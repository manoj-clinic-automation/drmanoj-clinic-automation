"""
salary_policy.py — v1.5 (S200/R7) — flow UX: bigger sheet fonts; approve strips on
...
_CSS = """
 ...
 th,td{border:1px solid #b9b0a0;padding:6px 9px;text-align:left;white-space:nowrap;font-size:15px}
    ...
    if staff is None and os.path.exists(_madv):
        ...
        if _rows:
            out.append("<h2>Advances settled OUTSIDE the ledger (owner's record)</h2>"
                       "<div class='note'>Already deducted when the month was paid — "
                       "shown for the record, not money to move.</div>"
