...
#
#   R1  NOTHING KEYED AFTER THE STOCK. An item-wise purchase export taken AFTER the stock export
#       carries a bill, dated inside what the earlier item-wise exports already covered, that none
#       of those earlier exports carried -> that bill was keyed after the stock was taken. RED.
            ...
            if not covered:
                ...
                if late:
                    ...
                    out["reasons"].append(
                        ...
                        "taken (e.g. bill %s%s of %s). Take a fresh STOCK CLOSING export now."
