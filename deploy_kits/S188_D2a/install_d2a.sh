#!/bin/bash
# =====================================================================
#  S188_D2a — Daily Flow v2, stage D2: Darpan's mirror  (D326)
#             + F-127, the maker's page stops receiving the unit position
#
#  TWO files, ONE install. They must move together: the page's fetch of the
#  unit-position endpoint is removed in the same breath as the endpoint gains
#  its checker gate. Either one alone leaves the page broken or the data open.
#
...
WANT_APP=db4373a5671dc90d384166a5771e098b
WANT_PAGE=8ec6ad494fd6b97e5c7c70b6c42fdfc5
# what this kit installs
NEW_APP=5a7fea4fe50f67a687bf27eeec97f411
NEW_PAGE=a114ebc48565491cd2d145ed767bb923

say(){ printf '%s\n' "$*"; }
die(){ say ""; say "*** RED: $*"; say "*** Nothing has been changed."; exit 1; }

say "==============================================================="
say " $KIT  ·  stage D2 (the mirror) + F-127 (the maker's page)"
say "==============================================================="
...
cp "$HERE/finance_app_D2a.py" "$STAGE/finance_app.py" || die "cannot stage the new app"
...
cp "$HERE/finance_app_D2a.py" "$APP"                     || { restore; die "the app swap failed"; }
...
say "   backup $BK"
say ""
say " WHAT CHANGED FOR DARPAN, in one line:"
say "   he now Saves, sees the bank/Marg check, then Files. Walk him"
say "   through it once, tomorrow morning, before 10am."
say ""
