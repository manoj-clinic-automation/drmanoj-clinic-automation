#!/usr/bin/python3
# -*- coding: utf-8 -*-
"""slip_log.py -- S324 (session 271, 19-Sep-2026). The OPD & X-ray/Proc slip tile, and the night
...
def patient(con, clinic_id):
    ...
    try:
        ...
        return None
    return (r["name"] or "", r["phone_last4"] or "") if r else None
...
def api_patient():
    ...
    return jsonify(ok=True, known=False, far=far, highest=hi)
