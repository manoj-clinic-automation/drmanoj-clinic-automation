...
def main():
    ...
    st, loc = save("shavez", {"series": "opd", "slip_no": "19374", "clinic_id": known["clinic_id"]})
    ...
    s, t = page("awdhesh")
    check("the room badge counts what is open", re.search(r'id="room"><summary><span>Room: Paid / Done</span><span class="badge">2 baaki', t) is not None)
    # ---- corrections
