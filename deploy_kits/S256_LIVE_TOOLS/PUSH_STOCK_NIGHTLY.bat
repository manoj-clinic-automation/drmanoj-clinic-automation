...
REM  S259 -- THE OFF SWITCH IS A FILE. Either marker stops all three steps;
REM  delete it and tonight's run goes ahead. Nothing to restart.
...
:off
echo.>> "%LOG%"
echo ############ NIGHTLY %DATE% %TIME%  OFF - a marker in %OFFDIR% is present; nothing sent >> "%LOG%"
echo.
echo  OFF - the nightly stock push is switched off. None of its three steps ran.
