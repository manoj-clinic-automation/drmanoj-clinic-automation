# KB HISTORY ARCHIVE — v1.4 (Tier 1 · append-only · out of the session loop)
...
**END OF KB HISTORY ARCHIVE v1.7. §S155 is the last section; §S154, §S153 and earlier sit above it. If §S154 or this marker is absent, this file is truncated and must not be used as canonical.**
