# KB HISTORY ARCHIVE — v1.9 (Tier 1 · append-only · out of the session loop)
...
**END OF KB HISTORY ARCHIVE v1.9. §S157 is the last section; §S156, §S155 and earlier sit above it. If §S157 or this marker is absent, this file is truncated and must not be used as canonical.**
