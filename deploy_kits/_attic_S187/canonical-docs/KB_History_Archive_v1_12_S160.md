# KB HISTORY ARCHIVE — v1.12 (Tier 1 · append-only · out of the session loop)
...
**END OF KB HISTORY ARCHIVE v1.12. §S160 is the last section; §S159, §S158 and earlier sit above it. If §S160 or this marker is absent, this file is truncated and must not be used as canonical.**
