# KB HISTORY ARCHIVE — v1.13 (Tier 1 · append-only · out of the session loop)
...
**END OF KB HISTORY ARCHIVE v1.13. §S161 is the last section; §S160, §S159 and earlier sit above it. If §S161 or this marker is absent, this file is truncated and must not be used as canonical.**
