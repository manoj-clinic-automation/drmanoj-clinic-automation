# KB HISTORY ARCHIVE — v1.0 (Tier 1 · append-only · out of the session loop)

**Dr. Manoj Agarwal Clinic · Bareilly · created S147, carried VERBATIM from Clinic_Master_KB_SystemsRegister v1.72 (md5 27b72639…).**

> This file holds the project's HISTORY: every session narrative (§S…) and every full-text decision block, unaltered. Authority on *what happened*. For *what is true now*, read the **KB Register v2.0** (Tier 0). Opened on demand only. (D247)
