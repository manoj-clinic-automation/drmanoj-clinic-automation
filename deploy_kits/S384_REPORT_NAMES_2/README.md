# S384_REPORT_NAMES_2 — step 3 of the Report baaki plan

*S384 = S383 with a clearer installer: S383 went red after placing without naming the check, its journal check
counted anyone's Traceback in the last two minutes. The payload is byte-identical.*
