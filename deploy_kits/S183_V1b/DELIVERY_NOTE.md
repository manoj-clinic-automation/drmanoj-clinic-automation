# S183_V1b — the F-97 structural fix (live-code pin verification)

**Session 183 · 16 Aug 2026 · read-only tool · nothing live is touched**

> **Re-issue of S183_V1a, which the VPS gate correctly refused.** V1a named the pin list
...
```
bash /root/deploy/vps_deploy.sh S183_V1b
```
...
---
*S183_V1b · built offline, gated, read-only · Session 183*
