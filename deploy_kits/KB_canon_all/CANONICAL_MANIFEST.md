...
| `live_pins_S225open.txt` | **S225 open** | `e6cded4a0e2d0fb0af38c1cce3d7007a` | **CURRENT** pin list, generated by `gen_live_pins.py` v1.2 from `KB_Register_v5_73_S225` against this manifest — `register_pin_verified: yes`. **84 VPS · 54 BLIND**: the five S221 prefix rows became full VPS rows; `clinic_register.py` now `93a31e68…`; `clinic_upi_check.py` `33d9a7bd…` after the F-320 reinstall, read back. |
