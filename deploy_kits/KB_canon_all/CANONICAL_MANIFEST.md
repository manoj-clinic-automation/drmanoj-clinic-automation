...
| `Fault_Action_Register` | **v2.36** | `37229a3142826c9ae40688f10a00d2ac` | **CURRENT** findings register (F-##). **v2.36 (S199 close): F-174 … F-177 appended the session they were raised, ALL FOUR CLOSED same-day** — F-174 (the exclusion-mirror drift; `S199_SALFIX`) · F-175 (the unlabeled checkbox polarity; dropdown + August migration) · F-176 (today-counted-absent; `S199_FLOW2`) · F-177 (the scenario's mislabeled months; `S199_SCEN3`). Next free F-178. Reverse-application-proven onto the `8670b952…` pin. |
