...
| `KB_History_Archive_v1_70_S224` | **S224 close** | `f4261441a042be2c8078bcd3aa6e838b` | **CURRENT** Tier-1 history. §S224 appended — the Marg lane closed in one sitting. **Pure append proven: the first 1,110,589 bytes byte-identical to v1.69 (md5 `1e4c4f18…`), +27,231 → 1,137,820.** |
...
| `live_pins_S225open.txt` | **S225 open** | `0349361e6c59bb3404dd4c71eccfea94` | **CURRENT** pin list, generated by `gen_live_pins.py` v1.2 from `KB_Register_v5_73_S225` against this manifest — `register_pin_verified: yes`. **84 VPS · 54 BLIND**: the five S221 prefix rows became full VPS rows; `clinic_register.py` now `93a31e68…`; `clinic_upi_check.py` `33d9a7bd…` after the F-320 reinstall, read back. |
...
| `CANONICAL_MANIFEST.md` | **S224 close** *(this cell had read S206 close through eighteen closes — corrected visibly at S224, the F-45 family)* | *(self — recomputed last, each EOS; the whole-file md5 is never written inside the file, F-122)* | this file; the linchpin. **Its own Version cell read `S179` from S179 until S203** — a claim about itself that had gone stale exactly as the STATUS block did (F-116/F-45). Corrected here, visibly. |
