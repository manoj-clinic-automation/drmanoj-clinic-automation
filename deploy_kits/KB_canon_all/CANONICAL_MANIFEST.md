...
| `START_HERE_PROMPT_v6` | **S207 close** | `dfad82a24b331096a4c0a2ab79844ca7` | **CURRENT** evergreen prompt / custom-instructions template. Names the four stores with the **real** ClaudeCowork path, the F-185 rule, the standing KB reduction, and **Phase 0 step 1 — check the folders AND the SSD and PROMPT the owner** rather than working around a missing one. Carries the cold-kit cadence, the SSD structure and the retention rule. Supersedes v5. *(Re-hashed after the same-session amendment; the earlier `3e436b19…` never left this close.)* |
| `HANDOFF_RUNBOOK_2026-08-28_Session207close_v141` | **S207 close** | `a343d952252247d04aafdf2e58f558a0` | **CURRENT** runbook. §2 is the close-time snapshot; `OWNER_TODO_LIVE.md` is the live list. |
...
| `START_HERE_SESSION_207` (pre-amendment) | S206 close | `be74e9801832c59d6a9c730724d417ba` | **CURRENT** session entry point. Phase 0 is **ALL TIERS by md5**; reading stays Tier 0. Carries **A0 the evidence rule**, the §S205 gap, the token rotation, and the rule that `where git` fails on manojz. |
...
| `KB_Register_v5_58_S207` | **S207 close** | `b52bb7fd6bc60018d481a9c76aa04938` | **CURRENT** Tier-0 register. Three of four self-referential lines stale, corrected visibly. |
...
| `HANDOFF_RUNBOOK_2026-08-27_Session206close_v140` | **S206 close** | `78b5b899e346f4ddbd83dc33e30bdb2e` | **CURRENT** runbook. §0 S206 · §2 the close-time backlog snapshot (live truth is `OWNER_TODO_LIVE.md`). |
