...
| `LOCAL_KB_EXTENSION_PLAYBOOK` | **S207 close** | `3f3cd28e2ff21958782ca2ff8bb07b61` | **CURRENT** — portable and **self-executing**: §0 is a block to paste into any project and §1 is what Claude then does, step by step. Four-store scheme, structure, cold-kit cadence, retention, the session-start check, and the five lessons. |
...
| `MARG_WALL_CARD` | S203 · D351 · **printed, not read** · **UPDATED S205** | `3a11a49a57ce0e6f1dfb597727b61efd` | one page of HTML, printed and kept **beside the medical PC**: what the machine does, what must stay on, the 60-second check, who to call. The only canonical document whose delivery surface is paper. |
