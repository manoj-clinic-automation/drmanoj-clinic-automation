...
| Doc | Version | md5 | Notes |
|---|---|---|---|
| `KB_History_Archive` | v1.29 | `8ef9bc8bdce233c03de60bdb75969dfd` | all history, verbatim; §S181 is last (appended at the S181 EOS; pure-append, **content before the v1.28 END marker byte-identical to the `0e8b4bd6…` pin**, +15,747 chars); END-marker present. |
