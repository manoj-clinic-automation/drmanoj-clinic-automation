...
| `START_HERE_SESSION_187` | **S186** | `6eaac2e8ea7323f38557215d699309f5` | **CURRENT** entry point. Phase 0 = git-clone hash check · the F-88 cross-check · the **F-107 inverse check** · `verify_live_pins.py` (expect **GREEN** this session — the pin list was regenerated at this close against a manifest that pins v5.11). Carries the S187 tasks: the item-wise go-live decision · **12 June's ₹8,487** · the F-107/F-108 structural checks. |
...
| `KB_Register` | **v5.11** | `d0da61a095435b1a3ef559c210788c37` | **CURRENT.** **S186 → v5.11 across FIVE bumps in one session** (v5.7 the completed `finance_app.py` pin + F-109/F-110; v5.8 F-112 + D323 + the cash close spec; v5.9 the close applied live; v5.10 the three upgrades' pins; v5.11 the ingest fix, the portal upload, F-104 cleared and **D324**). **Pins were recorded as they moved, not at the close** — deliberately, because unrecorded live pins are the F-97 condition and this session was spent digging out of it. Additive throughout; nothing in v5.6 cut. |
...
| `HANDOFF_RUNBOOK` | **v120 (S186)** | `b874064b7cab9b73898f335244f002ac` | **CURRENT.** §0 what happened (S186 — the three threads) · §1 mental models (+ *a record asserting something about another component is a claim, not a fact* · *a true statement can expire* · *test the mechanism, do not argue about it* · *the projection is the check*) · §2 live backlog — ⭐1 the item-wise go-live decision, ⭐2 the 12 June ₹8,487 · §3 install discipline; file `HANDOFF_RUNBOOK_2026-08-17_Session186close_v120.md` |
...
| Doc | Version | md5 | Notes |
|---|---|---|---|
| `KB_History_Archive` | **v1.34** | `e47a7069ce7d555487c325dbebf017cc` | **CURRENT.** All history, verbatim; **§S186 is last** — appended at the S186 close as a **pure append**, content before the v1.33 END marker **proven byte-identical** (+12,250 chars). END-marker present. |
...
| `Fault_Action_Register` | **v2.20** | `d7e553a9ba1e98f57e160879708bf977` | **CURRENT** findings register (F-##). **S186: F-109 … F-114 appended THE SAME SESSION they were raised — no owed append for the first time since S181.** §7 index extended F-108 → **F-114**; a new §7.1 continued section carries the full text; changelog row added; everything above the changelog **proven byte-identical** to v2.19. Next free **F-115**. |
...
**S186 canonical filenames (Phase-0 mapping):** `KB_Register_v5_11_S186.md` (`d5ec45a5…`) · `KB_History_Archive_v1_34_S186.md` (`e47a7069…`) · `Fault_Action_Register_v2_20.md` (`d7e553a9…`) · `HANDOFF_RUNBOOK_2026-08-17_Session186close_v120.md` (`b874064b…`) · `START_HERE_SESSION_187.md` (`6eaac2e8…`) · three new S186 finance docs · this `CANONICAL_MANIFEST.md`.
