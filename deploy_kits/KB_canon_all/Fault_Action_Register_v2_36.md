# FAULT → ACTION REGISTER — v2.36 (CONSOLIDATED, SELF-CONTAINED)
...
**END OF FAULT → ACTION REGISTER v2.36 — §7, §7.1 and the CHANGELOG are the last sections. If any of the three is absent, this file is truncated and must not be used as canonical.**
