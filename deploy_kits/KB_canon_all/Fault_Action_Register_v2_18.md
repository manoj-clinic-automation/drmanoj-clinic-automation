# FAULT → ACTION REGISTER — v2.18 (CONSOLIDATED, SELF-CONTAINED)
...
**v2.18, Session 182, 16 August 2026 — F-96 … F-99 appended to §7.1. Everything above §7.1's new block is byte-identical to v2.17.**
...
**END OF FAULT → ACTION REGISTER v2.18 — §7, §7.1 and the CHANGELOG are the last sections. If any of the three is absent, this file is truncated and must not be used as canonical.**
