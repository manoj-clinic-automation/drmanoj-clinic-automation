...
with sync_playwright() as pw:
    ...
    check("polio lead line in consent", "विशेष स्थिति" in out and "पोलियो" in out)
    check("polio prose in consent (S216 wording)", "उसी पैर में पोलियो का असर है" in out)
    check("the old bold heading is GONE", pg.locator("#cs_out h3.cs-mod").count()==0)
