#!/bin/bash
# S216_CP11_TONE - PAGE ONLY. CP-1.1 step 4: flow, tone, language switch.
# THIS KIT CHANGES CONSENT WORDING on the owner's written instructions.
set -e
K=$(cd "$(dirname "$0")" && pwd)
TS=$(date +%Y%m%d_%H%M%S)
\cp -v /root/wa/casepack/casepack_page.html "/root/wa/casepack/casepack_page.html.bak_S216_TONE_$TS"
