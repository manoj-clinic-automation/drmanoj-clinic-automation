...
with sync_playwright() as pw:
    ...
    chk("...three downloads in the box, in order: proof, the remaining sheet, the differences sheet",
        [a.get_attribute("class").split()[-1] for a in pg.locator("#padout a.dl").all()] == ["proof", "dl", "diffs"],
