#!/bin/bash
# =============================================================================
#  install_p1a.sh · kit S187_P1a — the Sanjeevni tile lands on the hub and
...
#
#  Rehearsal: P1A_FIN=... P1A_PORTAL=... P1A_DEPLOY=... P1A_NOSVC=1 bash install_p1a.sh
# =============================================================================
set -u
KIT_NAME="S187_P1a"
...
OLD_APP="cd3faaa4b30397f573d48bacf659bcf7"; NEW_APP="65f194243e4d465c4abbaae7e3b8f19e"
...
&& [ "$(cur finance_app_P1a.py)" = "$NEW_APP" ] \
...
# ---- finance first ----------------------------------------------------------
cp -f finance_app_P1a.py "$FIN/finance_app.py"
...
cp -f live_pins_P1a.txt "$DEP/live_pins.txt" && echo "-- pin list updated"
if [ "$NOSVC" != "1" ]; then
