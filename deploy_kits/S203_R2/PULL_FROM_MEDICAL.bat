...
:diagnose
ping -n 1 -w 1500 100.119.151.40 >nul 2>&1
if errorlevel 1 (
  echo   The medical PC does not answer at 100.119.151.40.
...
echo       cmdkey /list ^| findstr 100.119.151.40
echo   If nothing is listed, add one ^(it will ask for the password^):
echo       cmdkey /add:100.119.151.40 /user:MEDICAL\SET /pass
echo.
