...
<div class="wrap">
  ...
  <form method="POST" action="{{ prefix }}/fixabsents/apply">
    ...
    {% for b in blocks %}
    <h2 style="font-size:15px;margin:18px 0 4px">{{ b.name }}
      <span class="sub" style="font-weight:400">&mdash; absent {{ b.absent }}
        {% if b.corrected %}&middot; corrected {{ b.corrected }}
          &middot; <b>still absent {{ b.absent - b.corrected }}</b>{% endif %}</span></h2>
    {% if b.rows %}
    <table>
    ...
    {% else %}
      <div class="sub">Nothing left to correct for {{ b.name }}.</div>
    {% endif %}
    {% endfor %}
  ...
  <form method="POST" action="{{ prefix }}/fixabsents/undo">
    ...
    <h2 style="font-size:15px;margin:16px 0 4px">{{ b.name }}
      <span class="sub" style="font-weight:400">&mdash; {{ b.done | length }} corrected</span></h2>
    <table>
