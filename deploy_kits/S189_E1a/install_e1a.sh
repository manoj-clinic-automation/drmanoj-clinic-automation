#!/bin/bash
# =====================================================================
#  S189_E1a — the expense MENU: free text demoted, identity server-resolved
#
...
NEW_APP=7d6a87aa850df6c6678dc322d074de36
...
cp "$HERE/finance_app_E1a.py" "$STAGE/finance_app.py" || die "cannot stage the new app"
...
cp "$HERE/finance_app_E1a.py" "$APP"                     || { restore; die "the app swap failed"; }
