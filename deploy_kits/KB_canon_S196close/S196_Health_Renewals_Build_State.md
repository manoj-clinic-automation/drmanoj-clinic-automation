...
Cash-position + Hub card (S193, D333) · applied-status truth F-155 (S193) · Darpan accuracy on tile + save response (S195, verified in live bytes) · `/finance/health` cards: Marg push · days filed · cash position · cash/UPI split · correction checklist · UPI evidence · **month-vs-Marg + never-filed (alive from HLT3)** · flags · backup (S195) · **Renewals** (HLT1) · **worst-problem headline on the Sanjeevni tile itself** (HLT2). Live findings the page is currently flagging for the owner: 21-Aug unfiled · 1 Marg push to apply (F-155 behaviour: Apply correctly skipped the unfiled 21-Aug; auto-replay loads it the moment the day is filed) · 4 small UPI/bank disagreements · 1 cash/UPI split day to fix.
