...
with sync_playwright() as pw:
    ...
    chk("...the downloads in the box, in order: proof, the remaining sheet, the desk, the report, the differences sheet",
        [a.get_attribute("class").split()[-1] for a in pg.locator("#padout a.dl").all()] == ["proof", "dl", "desk", "report", "diffs"],
