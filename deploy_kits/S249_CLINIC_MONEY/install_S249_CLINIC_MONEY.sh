#!/bin/bash
# =============================================================================
#  install_S249_CLINIC_MONEY.sh · kit S249_CLINIC_MONEY
#
#  Run by:
...
#    /root/portal/tile_grants.json         v14 0efad736 -> v15   (kit)
...
declare -A FROM=( ["finance_clinic_day.py"]=56fb76198a6911ae512c3b73925a3c22
                  ...
                  ["tile_grants.json"]=0efad736e71de7199e7c596a5b3d0c2e )
...
"$PY" -c "import json,sys; g=json.load(open('tile_grants.json')); sys.exit(0 if g.get('version')==15 else 1)" || { echo "!! [4/9] tile_grants.json is not v15"; exit 1; }
echo "[4/9] every file compiles under $PY; grants v15"
...
echo
echo "=============================================================="
echo "  GREEN — S249_CLINIC_MONEY is live."
echo
