#!/usr/bin/python3
# -*- coding: utf-8 -*-
"""slip_log.py -- S324 (session 271, 19-Sep-2026), S325/S326 fixes the same morning: new = above the highest ID issued before the day. The OPD & X-ray/Proc slip tile, and the night
