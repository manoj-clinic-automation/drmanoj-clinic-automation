#!/usr/bin/python3
# -*- coding: utf-8 -*-
"""grant_kal_s359.py -- S359_CASH_LOG_2: Dr Bhawna gets the 'Kal ka hisaab' tile.
...
(bhawna is a medical viewer named in darpan_kal.recipients) is unchanged.
    ...
    python3 grant_kal_s359.py IN OUT
"""
import json
import sys

TILE = "Kal ka hisaab"
NOTE = (" | v24 (S359, 20-Sep-2026): 'Kal ka hisaab' to bhawna as well -- the owner's ruling that Darpan's daily cash "
        "goes to him or to Dr Bhawna and BOTH log what they received; her view of the page is the English "
        "'Cash handed to you' list with the log buttons (S359). Nothing else moves.")
