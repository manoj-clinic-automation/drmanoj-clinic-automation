...
# -*- coding: utf-8 -*-
"""
install_english_s222.py -- S222: the staff console goes English.
...
EXPECT_FROM = "adcbefeee6da6e5c13856a2baf9d3afe"
EXPECT_TO = "eb4e415de611f027c05929338f256a59"
...
def main():
    ...
    if cur == EXPECT_TO:
        print("already English -- nothing to do")
        return 0
    if cur != EXPECT_FROM:
        raise SystemExit("REFUSED: the live page is %s, not the %s this kit was built against "
                         "(S222_JOINER_ALLRECS must be in first). NOTHING was changed." % (cur, EXPECT_FROM))
    stamp = dt.datetime.now().strftime("%Y%m%d-%H%M%S")
    bak = TARGET + ".bak_S222_english_" + stamp
