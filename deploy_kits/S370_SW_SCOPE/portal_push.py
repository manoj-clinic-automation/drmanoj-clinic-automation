#!/usr/bin/env python3
# portal_push.py -- kit S366_RING_POPUP + S369_PUSH_DIAG + S370_SW_SCOPE (session 279, 22-Sep-2026)
...
def install(app, login_required, sso_user):
    ...
    def portal_sw():
        ...
        resp.headers["Service-Worker-Allowed"] = "/"   # S370: the scope is /portal (no slash) -- the page itself lives at /portal
        return resp
