...
`returns_data.py` now routes its FLOW-report file lists (sale / purchase exports)
...
SUMS.md5 row for returns_data.py regenerated the same day; everything else untouched.
