...
def clinic_day_detail(date):
    ...
    for key, title in SECTIONS:
        ...
        if not rows:
            continue
        out.append(_section(title, rows))
...
def _section(title, rows):
    ...
    for i, l in enumerate(rows, 1):
        tot += l["amount_p"] or 0
        body.append("<tr><td class='n sn'>%d</td><td class='p'>%s</td><td class='n cid'>%s</td>"
    ...
    return ("""<div class="card sect"><h2>%s</h2>
      <div class="tscroll"><table class="grid"><thead><tr>
        <th class="n sn">#</th><th class="p">Patient</th><th class="n cid">Clinic ID</th>
        <th class="r amt">Amount</th><th class="n mode">Mode</th><th class="n sh">Shift</th>
      </tr></thead><tbody>%s</tbody>
      <tfoot><tr><td></td><td>Subtotal</td><td class="n">%d</td>
