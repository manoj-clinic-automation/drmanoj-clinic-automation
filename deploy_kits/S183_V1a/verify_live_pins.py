#!/usr/bin/env python3
# =============================================================================
#  verify_live_pins.py  ·  v1.0  ·  Session 183  ·  the F-97 structural fix
#
...
#
#  USAGE
#     python3 verify_live_pins.py                    # check, using ./live_pins.tsv
#     python3 verify_live_pins.py --pins /path/to/live_pins.tsv
...
def main(argv=None):
    ...
    ap.add_argument("--pins", default=None,
                    help="path to live_pins.tsv (default: next to this script, "
    ...
    if args.pins:
        ...
        here = os.path.join(os.path.dirname(os.path.abspath(__file__)),
                            "live_pins.tsv")
        pins_path = here if os.path.isfile(here) else "live_pins.tsv"
