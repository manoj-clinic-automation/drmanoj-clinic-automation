...
#
#  Builds `live_pins.tsv` FROM the KB Register's live-file table.
#
...
#
#  USAGE
#     python gen_live_pins.py KB_Register_v5_4_S182.md -o live_pins.tsv
...
def build(register_path, out_path, session_label):
    ...
    lines = []
    lines.append("# live_pins.tsv -- generated by gen_live_pins.py v%s" % VERSION)
...
def main(argv=None):
    ap = argparse.ArgumentParser(
        description="Generate live_pins.tsv from the KB Register's live-file table.")
    ap.add_argument("register", nargs="?", help="path to the KB Register .md")
    ap.add_argument("-o", "--out", default="live_pins.tsv")
