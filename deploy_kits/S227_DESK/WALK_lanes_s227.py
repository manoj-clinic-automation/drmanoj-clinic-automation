...
with sync_playwright() as pw:
    ...
    chk("...the dead lane shows kind badges and the two Amir lists", pg.locator('.lane-dead .badge.kind').count() == 4 and "Amir's check list (Excel)" in body and "Marg cleanup list for Amir (Excel)" in body)
