...
def send_template(mobile10: str, template_name: str, variables: list[str],
    ...
    for attempt in range(retries + 1):
        ...
        try:
            ...
            # Transient server errors (5xx): retry with backoff. Proven S177:
            # MyOperator intermittently returns 500 {"message":null} and an
            # identical request succeeds moments later (F-82 root cause).
