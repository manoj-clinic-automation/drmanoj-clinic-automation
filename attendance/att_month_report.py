"""
att_month_report.py — v2 (S153) — monthly salary-inputs report (read-only; std-lib only).
...
ROSTER_FROM = "2026-09"        # D253 Sunday roster effective month
...
(duty presumed done — coach to punch out) &nbsp; blank grey = off day.</p>
